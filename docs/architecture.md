...
- Relation and artifact attachment writes inspect SQLite changes before emitting activity, so idempotent requests do not fabricate timeline events. Session links and Relations touch participating Tasks so Board recency remains meaningful.
